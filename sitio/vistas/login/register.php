...
<nav class="navbar navbar-default" role="navigation">
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="../../index.php" style="font-family: 'Lobster', cursive;">MEDIC</a>
		</div>
		<!-- menu items -->
			...
			<form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" name="signupform">
				<fieldset>
					...
					<div class="form-group">
						...
						<input type="text" name="name" placeholder="Nombre" required value="<?php if($error) echo $name; ?>" class="form-control" />

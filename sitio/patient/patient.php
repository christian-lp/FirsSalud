...
<body>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="" method="post" class="header-search">
                        ...
                        // Ejecuta la consulta SQL utilizando PDO
                        $stmt = $database->prepare($sqlmain);
                        $stmt->execute();
                        $results = $stmt->fetchAll(PDO::FETCH_ASSOC);

                        // Verifica si hay resultados utilizando count
                        if (count($results) > 0) {
                            foreach ($results as $row00) {
                                $d = $row00["pname"];
                                $c = $row00["pemail"];
                ...
                <center>
                    <div class="abc scroll">
                        <table width="93%" class="sub-table scrolldown" style="border-spacing:0;">
                            ...
                            // Verificar si hay resultados utilizando count
                            if (count($results) == 0) {
                                echo '<tr>
                                <td colspan="4">
                                <br><br><br><br>
                                ...
                                <br>
                                <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">No se encontraron resultados relacionados con tus palabras clave.</p>
                                <a class="non-style-link" href="patient.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Mostrar todos los Pacientes &nbsp;</button>
                                </a>
                                </center>
                                <br><br><br><br>
                                </td>
    ...
    if ($_GET) {
        ...
        $id = $_GET["id"];
        $action = $_GET["action"];
        $sqlmain = "select * from patient where id_patient='$id'";
